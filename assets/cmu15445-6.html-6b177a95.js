...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>bustub 的崩溃恢复必须先 Redo 再 Undo，首先 Redo 会扫描全部的日志文件，并通过 LSN 大小来重做未完成的事务，在重做期间记录正在活跃的事务，然后调用 Undo 来撤销这些操作。</p><h3 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h3>`,14)),n("ul",null,[n("li",null,[n("a",v,[e[0]||(e[0]=l("PROJECT #4 - LOGGING & RECOVERY")),s(i)])]),e[2]||(e[2]=n("li",null,"Database System Concepts 16",-1)),n("li",null,[n("a",t,[e[1]||(e[1]=l("Database Recovery")),s(i)])])])])}const f=r(c,[["render",b],["__file","cmu15445-6.html.vue"]]);export{f as default};
